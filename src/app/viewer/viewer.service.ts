...
export class ViewerService {
  ...
  curImages: any[] = [];
  curInterfaces: any[] = [];
  assetSrc = environment.production ? `https://raw.githubusercontent.com/academycitykonoha/bookshelf/master/src/campaigns` : `${this.baseHref}campaigns`;
